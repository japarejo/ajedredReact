...
public class JwtUtilService {
    ...
    @Autowired
    public JwtUtilService(UserService userService, GameService gameService) {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        PricingEvaluatorUtil util = new PricingEvaluatorUtil(planContext, evaluationContext, userContext,
